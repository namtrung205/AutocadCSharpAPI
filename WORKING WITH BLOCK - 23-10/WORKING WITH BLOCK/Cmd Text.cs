...
namespace myCustomCmds
{
    public class CmdText
    {
        ...
        public static void CreateTitleCallout2(string myTitle)
        {
            // Get the current document and database
            Document acCurDoc = Application.DocumentManager.MdiActiveDocument;
            Database acCurDb = acCurDoc.Database;
        ...
        public static void CreateTitleDetails()
        {
            ...
            Object mySelectPoint =  myCustomFunctions.SelectPoint(new Point3d(0, 0, 0), "Chon 1 diem de dat text...");

            if (mySelectPoint == null) return;
            
            Point3d myTextPlace = (Point3d)mySelectPoint;

            CmdLayer.createALayerByName("TEXT TITLE");

            // Title text
            // Create a title
            PromptStringOptions pStrOpts = new PromptStringOptions("\nEnter Title: ");
            pStrOpts.AllowSpaces = true;
            pStrOpts.DefaultValue = "myTitle";
            PromptResult pStrRes = acCurDoc.Editor.GetString(pStrOpts);
